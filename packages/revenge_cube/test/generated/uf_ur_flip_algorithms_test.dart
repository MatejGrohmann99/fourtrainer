...
import '../../lib/src/generated/ufur_flip_algorithms.g.dart';
    ...
    'ufurFlipAlgorithms:',
      ...
      test(
        'Every generated algorithm does flips UF UR edges and does not effect UB DF DR DB DL',
          ...
          int lineCount = 2;
          for (final algorithm in ufurFlipAlgorithms) {
...
''');
          ...
          if (failedTests.isNotEmpty) {
            failedTests.insert(
              0,
              'ufurFlipAlgorithms test failed ${failedTests.length} times out of ${ufurFlipAlgorithms.length} tests',
            );
