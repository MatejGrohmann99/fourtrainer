...
void main() {
  group(
    ...
    () {
      test(
        'Every generated algorithm does flips UF UB edges, PERMUTES UR TO FR and does not effect DF DR DB DL',
        () {
          ...
          for (final algorithm in threeCycleSetupAlgorithms) {
            ...
            try {
              ...
              final endStateRFEdgeTuple = (endState.state[1][1][2], endState.state[2][1][0]);
              expect(cubeStateUREdgeTuple.$1, endStateRFEdgeTuple.$2);
              expect(cubeStateUREdgeTuple.$2, endStateRFEdgeTuple.$1);
...
file:         package:fourtrainer/src/domain/algorithms/three_cycle_setup_algorithms.g.dart $lineCount:0
algorithm:    $algorithm
$e
''');
            }
